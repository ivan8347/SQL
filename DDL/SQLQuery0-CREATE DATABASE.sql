...
CREATE DATABASE SPU_411_ALL_1
ON
(
NAME = SPU_411_ALL,
FILENAME =  'D:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\SPU_411_ALL_1.mdf',
SIZE       = 8 MB,
MAXSIZE    = 500 MB,
FILEGROWTH = 8 MB
)
...
FILENAME   = 'D:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\SPU_411_ALL_1.ldf',
SIZE       = 8 MB,
MAXSIZE    = 500 MB,
FILEGROWTH = 5 MB
)